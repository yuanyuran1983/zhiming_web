...
namespace zhiming_web
{
    ...
    public class WebService1 : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public string Login(string id, string pwd)//登录
        {
...
*/
		...
		[WebMethod]
		//prepare for 更换项目
        public string ChaXunXiaofeiXiangmu_byGuestID(string guest_id)
        {
            string sql = "'";

            sql = "select * from shoupai a,xiaofeixiangmu b where a.手牌号='" + guest_id + "'";
            sql = sql + " and b.完成情况='进行中'";
